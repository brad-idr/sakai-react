            ...
            <div id="home" className="landing-wrapper overflow-hidden">
                <div className="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center  relative lg:static">
                    <Link href="/" className="flex align-items-center">
                        <span className="text-900 font-medium text-2xl line-height-3 mr-8">Landing Page</span>
                    </Link>
                    <Link href="/crm" className="flex align-items-center">
                        <span className="text-900 font-medium text-2xl line-height-3 mr-8">CRM Dashboard</span>
                    </Link>
                </div>
